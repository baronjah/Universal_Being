extends Node3D
class_name VRElementInteraction_vrelementinteraction
...
var element_scenes = {
	"fire": preload("res://scripts/gdscript/scripts/elements_shapes_projection/element_fire.tscn") if File.new().file_exists("res://code/gdscript/scripts/elements_shapes_projection/element_fire.tscn") else null,
	"water": preload("res://scripts/gdscript/scripts/elements_shapes_projection/element_water.tscn") if File.new().file_exists("res://code/gdscript/scripts/elements_shapes_projection/element_water.tscn") else null,
	"wood": preload("res://scripts/gdscript/scripts/elements_shapes_projection/element_wood.tscn") if File.new().file_exists("res://code/gdscript/scripts/elements_shapes_projection/element_wood.tscn") else null,
	"ash": preload("res://scripts/gdscript/scripts/elements_shapes_projection/element_ash.tscn") if File.new().file_exists("res://code/gdscript/scripts/elements_shapes_projection/element_ash.tscn") else null
}
