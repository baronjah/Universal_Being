extends Node3D
class_name JSHTextWindow_textscreen
...
func create_button_0(name, position, size, color, label_text):
	var button = Node3D.new()
	button.name = name
	add_child(button)
...
func _on_button_input_event_0(name, camera, event, pos, normal, shape_idx):
	if event is InputEventMouseButton and event.pressed and event.button_index == MOUSE_BUTTON_LEFT:
		match name:
			"CloseButton":
				emit_signal("window_closed")
...
func create_button_old(name, position, size, color, label_text):
	var button = Node3D.new()
	button.name = name
	add_child(button)
...
func _on_button_input_event_old(name, camera, event, pos, normal, shape_idx):
	if event is InputEventMouseButton and event.pressed and event.button_index == MOUSE_BUTTON_LEFT:
		match name:
			"CloseButton":
				emit_signal("window_closed")
...
func create_input_field():
	...
	input_field.add_child(input_mesh)
	var input_height = 0.2
	var vertices = PackedVector3Array()
	var indices = PackedInt32Array()
	...
	input_field.add_child(input_text)
	input_text.text = ""
...
#extends Node3D
#class_name JSHChatWindow_textscreen
...
#class_name TextWindowSystem_textscreen
#extends Node3D
...
func create_button_old_v1(name, position, size, color, label_text):
	var button = Node3D.new()
	button.name = name
	add_child(button)
	# Create button background
...
func _on_button_input_event_old_v1(name, camera, event, pos, normal, shape_idx):
...
# Helper function to create buttons
func create_button_old_v2(name, position, size, color, label_text):
	var button = Node3D.new()
	button.name = name
	add_child(button)
	# Create button background
