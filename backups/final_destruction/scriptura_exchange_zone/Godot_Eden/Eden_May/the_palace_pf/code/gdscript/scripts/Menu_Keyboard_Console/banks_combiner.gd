...
# class_name BanksCombiner_bankscombiner
#
...
class_name BanksCombiner_bankscombiner #BanksCombiner.combination_0 
...
const data_sets_names_0 = [
	"base", "menu", "settings", "keyboard", "keyboard_left", "keyboard_right", "things_creation", "singular_lines", "snake"
]
