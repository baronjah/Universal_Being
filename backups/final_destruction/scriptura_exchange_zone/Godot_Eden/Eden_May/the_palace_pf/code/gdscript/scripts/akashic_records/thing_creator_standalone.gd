extends Node
class_name ThingCreatorStandaloneA_thingcreatorstandalone
...
func find_akashic_records() -> void:
	...
	if akashic_records_manager:
		...
		print("Attempting to create AkashicRecordsManager instance")
		...
		if akashic_records_manager:
			...
			print("Created and initialized AkashicRecordsManager")
		else:
			print("Could not create AkashicRecordsManager")
...
func setup_thing_creator() -> void:
	...
	thing_creator = find_node_by_class("ThingCreatorA")
	if thing_creator:
