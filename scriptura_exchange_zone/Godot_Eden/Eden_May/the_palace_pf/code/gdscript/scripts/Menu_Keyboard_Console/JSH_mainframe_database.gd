...
func _add_system_function(name: String, execution_time: float = 5.0) -> void:
	var function = Function.new(name, FunctionType.SYSTEM, execution_time)
	function.set_resource_requirement("ram", 2)
	function.set_resource_requirement("cpu", 10.0)
	functions[name] = function

# Add an input function
func _add_input_function(name: String, execution_time: float = 2.0) -> void:
	var function = Function.new(name, FunctionType.INPUT, execution_time)
	function.set_resource_requirement("ram", 1)
	function.set_resource_requirement("cpu", 5.0)
	functions[name] = function

# Add a file function
func _add_file_function(name: String, execution_time: float = 4.0) -> void:
	var function = Function.new(name, FunctionType.FILE, execution_time)
	function.set_resource_requirement("ram", 3)
	function.set_resource_requirement("files", 1)
	functions[name] = function

# Add a render function
func _add_render_function(name: String, execution_time: float = 3.0) -> void:
	var function = Function.new(name, FunctionType.RENDER, execution_time)
	function.set_resource_requirement("cpu", 15.0)
	functions[name] = function

# Add a process function
func _add_process_function(name: String, execution_time: float = 4.0) -> void:
	var function = Function.new(name, FunctionType.PROCESS, execution_time)
	function.set_resource_requirement("cpu", 10.0)
	functions[name] = function

# Add a memory function
func _add_memory_function(name: String, execution_time: float = 3.0) -> void:
	var function = Function.new(name, FunctionType.MEMORY, execution_time)
