...
func _draw_sphere(position: Vector3, radius: float, material: Material) -> void:
	var mesh_instance = MeshInstance3D.new()
...
func _create_label(position: Vector3, text: String, color: Color) -> void:
