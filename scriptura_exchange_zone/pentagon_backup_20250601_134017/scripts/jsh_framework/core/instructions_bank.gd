# 🏛️ Instructions Bank - Ragdoll physics and behavior system
...
extends Node3D#
class_name InstructionsBank_instruct # InstructionsBank.instructions_set_0   InstructionsBank.type_of_instruction_0#
