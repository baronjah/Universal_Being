...
# Console state
var active_universe: UniverseUniversalBeing = null
...
func create_new_universe(name: String) -> void:
    ...
    var universe = UniverseUniversalBeing.new()
...
func open_portal(from_universe: String, to_universe: String) -> void:
    ...
    if SystemBootstrap and SystemBootstrap.is_system_ready():
        ...
        if flood_gates:
            ...
            if from_uni and to_uni and from_uni is UniverseUniversalBeing and to_uni is UniverseUniversalBeing:
                # Create portal
